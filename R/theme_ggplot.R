...
theme_ggplot <- function() {
  ggplot2::theme(
    ...
    panel.grid.major.y = ggplot2::element_line(color = "grey85", linetype = "dotted", linewidth = ggplot2::rel(.75)),
    panel.grid.major.x = ggplot2::element_line(color = "grey85", linetype = "dotted", linewidth = ggplot2::rel(.75)),
